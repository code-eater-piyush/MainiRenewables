        ...
        <div className="contact-container" ref={contentRef}>
          ...
          <div className="form-container slide-in">
            ...
            <form>
              ...
              <input type="text" name="siteLocation" placeholder="Google Map Pin" required />
          ...
          <div className="info slide-in">
            <h2><FaEnvelope /> Info Email</h2>
            <p>Email us at: <a href="mailto:info@mainirenewables.com">info@mainirenewables.com</a></p>
            <p>We’re here to assist you with any inquiries regarding our services.</p>
          </div>
          ...
          <div className="faqs slide-in">
            <h2><FaQuestionCircle /> Queries / FAQs</h2>
            <div className="faq">
              {[
                { question: "What services do you offer?", answer: "We provide innovative renewable energy solutions tailored to your needs." },
                { question: "How can I get a quote?", answer: "Simply fill out the contact form, and we will get back to you with a personalized quote." },
                { question: "Where are you located?", answer: "Our office is situated in the heart of the city, easily accessible for consultations." },
                { question: "How can I track my project progress?", answer: "We provide regular updates through email and our project management system." }
              ].map((item, index) => (
                <div key={index}>
                  <div
